...
class Camera:
    net = cv.dnn.readNetFromCaffe('backend/models/config.txt', 'backend/models/mobilenet_iter_73000.caffemodel')
    ...
    def run(self):
        ...
        while self.armed:
            ...
            blob = cv.dnn.blobFromImage(frame, 0.007843, (100, 100), 30)
